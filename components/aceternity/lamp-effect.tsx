    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(from 90deg at 50% 50%, hsl(var(--primary)) 0deg, hsl(var(--secondary)) 120deg, transparent 180deg)`,
          }}
        ...
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(from 270deg at 50% 50%, hsl(var(--primary)) 0deg, hsl(var(--secondary)) 120deg, transparent 180deg)`,
          }}
